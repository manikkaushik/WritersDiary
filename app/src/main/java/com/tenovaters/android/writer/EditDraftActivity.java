...
public class EditDraftActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /* renamed from: e1 */
    public EditText f557e1;
    /* access modifiers changed from: private */

    /* renamed from: e2 */
    public EditText f558e2;
    /* access modifiers changed from: private */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_edit_draft);
        this.toolbar = (Toolbar) findViewById(R.id.feed_toolbar);
        this.btn = (Button) findViewById(R.id.btn_next);
        this.btn2 = (Button) findViewById(R.id.btn_skip);
        this.f557e1 = (EditText) findViewById(R.id.et_title);
        this.f558e2 = (EditText) findViewById(R.id.et_description);
        this.toolbar.setTitle((CharSequence) "Information");
        this.pro = (ProgressBar) findViewById(R.id.pro_editdraft);
        ...
        this.rootref = FirebaseDatabase.getInstance().getReference(str).child(this.currentUser);
        this.demoref = FirebaseDatabase.getInstance().getReference(str).child(this.currentUser);
        ...
        this.f557e1.setText(this.title);
        this.f558e2.setText(this.description);
        this.btn2.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(EditDraftActivity.this, Writting2Activity.class);
                intent.putExtra("Id", EditDraftActivity.this.userid);
                intent.putExtra("Title", EditDraftActivity.this.title);
        ...
        if (!haveNetwork().booleanValue()) {
            ...
            this.mDatabaseRef.child(this.currentUser).child(this.userid).addValueEventListener(new ValueEventListener() {
                public void onDataChange(DataSnapshot dataSnapshot) {
                    DataSnapshot dataSnapshot2 = dataSnapshot;
                    String genere = (String) dataSnapshot2.child("genere").getValue(String.class);
                    EditDraftActivity.this.image = (String) dataSnapshot2.child(MessengerShareContentUtility.MEDIA_IMAGE).getValue(String.class);
                    EditDraftActivity.this.my_story = (String) dataSnapshot2.child("story").getValue(String.class);
                    if (EditDraftActivity.this.image != null) {
                        Picasso.with(EditDraftActivity.this).load(EditDraftActivity.this.image).fit().centerCrop().placeholder((int) R.drawable.plus_image).into(EditDraftActivity.this.img);
                    }
                    String str = "Category";
                    ...
                    if (genere != null) {
                        if (genere.equals("Story")) {
                            EditDraftActivity.this.story.setChecked(true);
                        } else {
                            EditDraftActivity.this.poem.setChecked(true);
                        }
                    }
                    if (abstract_s != null) {
                        EditDraftActivity.this.action1.setSelected(true);
                        EditDraftActivity.this.action1.setChecked(true);
                    }
                    if (action_s != null) {
                        EditDraftActivity.this.action2.setSelected(true);
                        EditDraftActivity.this.action2.setChecked(true);
                    }
                    if (children_s != null) {
                        EditDraftActivity.this.children.setSelected(true);
                        EditDraftActivity.this.children.setChecked(true);
                    }
                    if (classic_s != null) {
                        EditDraftActivity.this.classic.setSelected(true);
                        EditDraftActivity.this.classic.setChecked(true);
                    }
                    if (comedy_s != null) {
                        EditDraftActivity.this.comedy.setSelected(true);
                        EditDraftActivity.this.comedy.setChecked(true);
                    }
                    if (crime_s != null) {
                        EditDraftActivity.this.crime.setSelected(true);
                        EditDraftActivity.this.crime.setChecked(true);
                    }
                    if (drama_s != null) {
                        EditDraftActivity.this.drama.setSelected(true);
                        EditDraftActivity.this.drama.setChecked(true);
                    }
                    if (fantasy_s != null) {
                        EditDraftActivity.this.action1.setSelected(true);
                        EditDraftActivity.this.fantasy.setChecked(true);
                    }
                    if (horror_s != null) {
                        EditDraftActivity.this.horror.setSelected(true);
                        EditDraftActivity.this.horror.setChecked(true);
                    }
                    if (inspirational_s != null) {
                        EditDraftActivity.this.inspirational.setSelected(true);
                        EditDraftActivity.this.inspirational.setChecked(true);
                    }
                    if (romance_s != null) {
                        EditDraftActivity.this.romance.setSelected(true);
                        EditDraftActivity.this.romance.setChecked(true);
                    }
                    if (thriller_s != null) {
                        EditDraftActivity.this.thriller.setSelected(true);
                        EditDraftActivity.this.thriller.setChecked(true);
                    }
                    if (tragedy_s != null) {
                        EditDraftActivity.this.tragedy.setSelected(true);
                        EditDraftActivity.this.tragedy.setChecked(true);
                    }
                    if (others_s != null) {
                        EditDraftActivity.this.other.setSelected(true);
                        EditDraftActivity.this.other.setChecked(true);
                    }
                }

                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(EditDraftActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        this.btn.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (!EditDraftActivity.this.haveNetwork().booleanValue()) {
                    Toast.makeText(EditDraftActivity.this, "No Internet Connection!", Toast.LENGTH_SHORT).show();
                    return;
                }
                String obj = EditDraftActivity.this.f557e1.getText().toString();
                String obj2 = EditDraftActivity.this.f558e2.getText().toString();
                int selectedId = EditDraftActivity.this.radioGroup.getCheckedRadioButtonId();
                if (selectedId == R.id.poem_story) {
                    EditDraftActivity.this.Genere = "Poem";
                } else if (selectedId == R.id.story_story) {
                    EditDraftActivity.this.Genere = "Story";
                }
                EditDraftActivity.this.category();
                EditDraftActivity editDraftActivity = EditDraftActivity.this;
                editDraftActivity.count1 = String.valueOf(editDraftActivity.count);
                EditDraftActivity.this.compressImage();
            }
        });
    }
    ...
    public void compressImage() {
        if (this.actualImage == null) {
            this.title = this.f557e1.getText().toString();
            this.description = this.f558e2.getText().toString();
            ReadersList readersList = new ReadersList(this.title, this.description, this.count1, this.image, this.userid, this.currentUser, this.Genere, "Unpublished", this.my_story);
            this.demoref.child(this.userid).setValue(readersList).addOnCompleteListener(new OnCompleteListener<Void>() {
                public void onComplete(Task<Void> task) {
                    EditDraftActivity.this.category_set();
                    Intent intent = new Intent(EditDraftActivity.this, Writting2Activity.class);
                    intent.putExtra("Id", EditDraftActivity.this.userid);
                    intent.putExtra("Title", EditDraftActivity.this.title);
                    Toast.makeText(EditDraftActivity.this, "Details Updated successful", Toast.LENGTH_LONG).show();
                    EditDraftActivity.this.startActivity(intent);
                    EditDraftActivity.this.finish();
                }
        ...
        new Compressor(this).compressToFileAsFlowable(this.actualImage).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<File>() {
            public void accept(File file) {
                EditDraftActivity.this.compressedImage = file;
                EditDraftActivity.this.setCompressedImage();
            }
        }, new Consumer<Throwable>() {
            public void accept(Throwable throwable) {
                throwable.printStackTrace();
                Toast.makeText(EditDraftActivity.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void uploadFile() {
        if (this.filepath != null) {
            ...
            this.mUploadTask = fileReference.putFile(this.filepath).addOnSuccessListener((OnSuccessListener) new OnSuccessListener<TaskSnapshot>() {
                public void onSuccess(TaskSnapshot taskSnapshot) {
                    ...
                    fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        public void onSuccess(Uri uri) {
                            Toast.makeText(EditDraftActivity.this, "Upload successful", Toast.LENGTH_LONG).show();
                            ReadersList readersList = new ReadersList(EditDraftActivity.this.title, EditDraftActivity.this.description, EditDraftActivity.this.count1, uri.toString(), EditDraftActivity.this.userid, EditDraftActivity.this.currentUser, EditDraftActivity.this.Genere, "Unpublished", EditDraftActivity.this.my_story);
                            EditDraftActivity.this.demoref.child(EditDraftActivity.this.userid).setValue(readersList).addOnCompleteListener(new OnCompleteListener<Void>() {
                                public void onComplete(Task<Void> task) {
                                    EditDraftActivity.this.category_set();
                                    Intent intent = new Intent(EditDraftActivity.this, Writting2Activity.class);
                                    intent.putExtra("Id", EditDraftActivity.this.userid);
                                    intent.putExtra("Title", EditDraftActivity.this.title);
                                    EditDraftActivity.this.pro.setVisibility(View.GONE);
                                    EditDraftActivity.this.startActivity(intent);
                                    EditDraftActivity.this.finish();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(Exception e) {
                    Toast.makeText(EditDraftActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    EditDraftActivity.this.pro.setVisibility(View.GONE);
                }
