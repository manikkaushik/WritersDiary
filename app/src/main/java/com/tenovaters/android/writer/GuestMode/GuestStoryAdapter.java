...
public class GuestStoryAdapter extends RecyclerView.Adapter<GuestStoryAdapter.ImageViewHolder> {
    ...
    public GuestStoryAdapter(Context context, List<ReadersList> uploads) {
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(GuestStoryAdapter.this.mContext1, GuestReaderActivity.class);
                ...
                GuestStoryAdapter.this.mContext1.startActivity(intent);
            }
        });
    }
